...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if ($_POST['submit'] == "Update") {
		// Obtener tipo de página y detalles
		$pagetype = $_GET['type'];
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
		...
		<!-- Scripts para validación y navegación -->
		<script type="text/JavaScript">
			<!--
			// Función para encontrar objetos del DOM
			...
			<div class="left-content">
				...
				<div class="grid-form">
					...
					<div class="grid-form1">
						<h3>Actualizar datos de la página</h3>
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<?php
											// Mostrar nombre de página según tipo seleccionado
											switch ($_GET['type']) {
												case "terms":
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Detalles de la página</label>
										<div class="col-sm-8">


											<textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Detalles del paquete" required>
										<?php
										// Obtener detalles de la página seleccionada
										$pagetype = $_GET['type'];
