...
if (strlen($_SESSION['login']) == 0) {
	...
	// Procesamos la actualización del perfil si se envió el formulario
...
?>
	...
	<body>
		...
		<div class="top-header">
			...
			<div class="banner-1 ">
				<div class="container">
					<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Chompi en Quibdo</h1>
				</div>
			</div>
			<!-- Contenido principal -->
			<div class="privacy">
